...
function calculateMainTable(columnIndex,columnName="") {
    ...
    var Formula30 = convertAmount((evaluateFormula(columnIndex+'29/'+columnIndex+'15',true)) * 1000,false); // '(D29/D15)*1000'
    setVariableData(columnIndex+"30",Formula30, "amount",2); // SNS/ 9L Case
    var Formula26 = convertAmount(evaluateFormula(columnIndex+'27*'+columnIndex+'15',true),true); // 'D27*D15'
    setVariableData(columnIndex+"26",Formula26, "amount",0); // EXCISE TAXES
    var Formula23 = convertAmount(evaluateFormula(columnIndex+'29+'+columnIndex+'26',true)); // 'D29+D26'
    setVariableData(columnIndex+"23",Formula23, "amount",0); // NET SALES
    var Formula24 = convertAmount((evaluateFormula(columnIndex+'23/'+columnIndex+'15',true)) * 1000); // '(D23/D15)*1000'
    ...
    if(columnIndex == "H"){
        ...
        var ForumulaI29= convertAmount(evaluateFormula(columnIndex+'29/E29-1',true) * 100) // (H29/E29-1)*100 (perc)
        ...
        var Formula20 = convertAmount(evaluateFormula(columnIndex+'21*'+columnIndex+'15',true),true); // 'D21*D15'
        setVariableData(columnIndex+"20",Formula20, "amount",0); // DISCOUNTS
    }
    ...
    var Formula18 = convertAmount((evaluateFormula(columnIndex+'17/'+columnIndex+'15',true) * 1000)); // '(D17/D15)*1000'
    ...
    var Formula33 = convertAmount((evaluateFormula(columnIndex+'32/'+columnIndex+'15',true)) * 1000); // '(D32/D15)*1000'
    ...
    var Formula36 = convertAmount((evaluateFormula(columnIndex+'35/'+columnIndex+'15',true)) * 1000); // '(D35/D15)*1000'
    setVariableData(columnIndex+"36",Formula36, "amount",2); // GP/ 9L
    var Formula37 = convertAmount((evaluateFormula(columnIndex+'35/'+columnIndex+'29',true)) * 100); // '(D35/D29)*100 (perc)'
...
function calculateWorkingTotalOfMainTable(columnIndex,columnName="") {
    ...
    var Formula58 = convertAmount(evaluateFormula(columnIndex+'53/'+columnIndex+'52',true) * 100); // (D53/D52)*100 (perc)
    setVariableData(columnIndex+"58",Formula58, "percentage",1); // Paid Media
    var Formula59 = convertAmount(evaluateFormula(columnIndex+'54/'+columnIndex+'52',true) * 100); // (D54/D52)*100 (perc)
    setVariableData(columnIndex+"59",Formula59, "percentage",1); // Activation
    var Formula60 = convertAmount(evaluateFormula(columnIndex+'55/'+columnIndex+'52',true) * 100); // (D55/D52)*100 (perc)
...
function calculateKToRColumn() {
    ...
    // 750 Ml===============
    var FormulaK139 = convertAmount(evaluateFormula(bottomTableData['E139']+"+"+bottomTableData['P139'], false)); // 'E139+P139'
    bottomTableData["K139"] = FormulaK139;

    var FormulaK137 = convertAmount(evaluateFormula(bottomTableData['E137']+"*"+bottomTableData['M137'], false)); // 'E137*M137'
    ...
    // 750ml VAP===================
    // K130
    var FormulaK130 = convertAmount(evaluateFormula(bottomTableData['E130']+"+"+bottomTableData['P130']+'+'+bottomTableData['Q130'], false)); // E130+P130+Q130
    bottomTableData["K130"] = FormulaK130;
    // K128
    var FormulaK128 = convertAmount(evaluateFormula(bottomTableData['E128']+"*"+bottomTableData['M128'], false)); // E128*M128
    ...
    // 50ml===================
    // K121
    var FormulaK121 = convertAmount(evaluateFormula(bottomTableData['E121']+"+"+bottomTableData['P121'], false)); // E121+P121
    bottomTableData["K121"] = FormulaK121;
    // K119
    var FormulaK119 = convertAmount(evaluateFormula(bottomTableData['E119']+"*"+bottomTableData['M119'], false)); // E119*M119
    ...
    // 375ml===================
    // K103
    var FormulaK103 = convertAmount(evaluateFormula(bottomTableData['E103']+"+"+bottomTableData['P103'], false)); // E103+P103
    bottomTableData["K103"] = FormulaK103;
    // K101
    var FormulaK101 = convertAmount(evaluateFormula(bottomTableData['E101']+"*"+bottomTableData['M101'], false)); // E101*M101
    ...
    // 750ml===================
    // K94
    var FormulaK94 = convertAmount(evaluateFormula(bottomTableData['E94']+"+"+bottomTableData['P94'], false)); // E103+P103
    bottomTableData["K94"] = FormulaK94;
    // K92
    var FormulaK92 = convertAmount(evaluateFormula(bottomTableData['E92']+"*"+bottomTableData['M92']+"*"+bottomTableData['N92'], false)); // E92*M92*N92
    bottomTableData["K92"] = FormulaK92;

    // 1 L=================================
    // K85
    var FormulaK85 = convertAmount(evaluateFormula(bottomTableData['E85']+"+"+bottomTableData['P85'], false)); // E85+P85
    bottomTableData["K85"] = FormulaK85;
    // K83
    var FormulaK83 = convertAmount(evaluateFormula(bottomTableData['E83']+"*"+bottomTableData['M83'], false)); // E83*M83
    ...
    // 1.75 L=================================
    // K76
    var FormulaK76 = convertAmount(evaluateFormula(bottomTableData['E76']+"+"+bottomTableData['P76'], false)); // E76+P76
    bottomTableData["K76"] = FormulaK76;
    // K74
    var FormulaK74 = convertAmount(evaluateFormula(bottomTableData['E74']+"*"+bottomTableData['M74'], false)); // E74*M74
...
function calculateBottomTable(columnIndex,columnName="") {
    ...
    var Formula78 = convertAmount(evaluateFormula(columnIndex+'74-'+columnIndex+'76', false)); // 'D74-D76'
    ...
    var Formula80 = convertAmount(evaluateFormula(columnIndex+'78/'+columnIndex+'74', false) * 100); // '(D78/D74)*100 (perc)'
    ...
    var Formula89 = convertAmount(evaluateFormula(columnIndex+'87/'+columnIndex+'83', false) * 100); // '(D87/D83)*100 (perc)'
    ...
    var Formula96 = convertAmount(evaluateFormula(columnIndex+'92-'+columnIndex+'94', false)); // 'D92-D94'
    ...
    var Formula98 = convertAmount(evaluateFormula(columnIndex+'96/'+columnIndex+'92', false) * 100); // '(D96/D92)*100 (perc)'
    ...
    var Formula105 = convertAmount(evaluateFormula(columnIndex+'101-'+columnIndex+'103', false)); // 'D101-D103'
    ...
    var Formula107 = convertAmount(evaluateFormula(columnIndex+'105/'+columnIndex+'101', false) * 100); // '(D105/D101)*100 (perc)'
    ...
    var Formula114 = convertAmount(evaluateFormula(columnIndex+'110-'+columnIndex+'112', false)); // 'D110-D112'
    ...
    var Formula116 = convertAmount(evaluateFormula(columnIndex+'114/'+columnIndex+'110', false) * 100); // '(D114/D110)*100 (perc)'
    ...
    var Formula123 = convertAmount(evaluateFormula(columnIndex+'119-'+columnIndex+'121', false)); // 'D119-D121'
    ...
    var Formula125 = convertAmount(evaluateFormula(columnIndex+'123/'+columnIndex+'119', false) * 100); // '(D123/D119)*100 (perc)'
    ...
    var Formula132 = convertAmount(evaluateFormula(columnIndex+'128-'+columnIndex+'130', false)); // 'D128-D130'
    ...
    var Formula134 = convertAmount(evaluateFormula(columnIndex+'132/'+columnIndex+'128', false) * 100); // '(D132/D128)*100 (perc)'
    ...
    var Formula141 = convertAmount(evaluateFormula(columnIndex+'137-'+columnIndex+'139', false)); // 'D137-D139'
    ...
    var Formula143 = convertAmount(evaluateFormula(columnIndex+'141/'+columnIndex+'137', false) * 100); // '(D141/D137)*100 (perc)'
