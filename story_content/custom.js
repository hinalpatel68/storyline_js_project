...
function defineStaticValueForMainTable(){
    ...
    var staticD21=16.25;
    setVariableData("D21",staticD21, "amount"); // Discounts/ 9L Case
    var staticD27=28.75;
    setVariableData("D27",staticD27, "amount"); // Excise Tax/ 9L Case
    var staticD39=3578183.33760167;
    setVariableData("D39",convertAmount(staticD39,0,true), "amount"); // BRAND EXPENSE
    var staticD44=5311157.84594032;
    setVariableData("D44",convertAmount(staticD44,0,true), "amount"); // SG&A
    //...
    var staticE21=14.77125;
    setVariableData("E21",convertAmount(staticE21,2),"amount"); // Discounts/ 9L Case   
    var staticE27=28.75;
    setVariableData("E27",staticE27, "amount"); // Excise Tax/ 9L Case
    var staticE39=3815575.45976621;
    setVariableData("E39",convertAmount(staticE39,0,true), "amount"); // BRAND EXPENSE
    var staticE44=5366175.72982854;
    setVariableData("E44",convertAmount(staticE44,0,true), "amount"); // SG&A
    //...
    var staticF27=28.75;
    setVariableData("H27",staticF27, "amount"); // Excise Tax/ 9L Case

    // Dollars in thousands
    var staticD53=1667433.43532238;
    setVariableData("D53",convertAmount(staticD53,0,true), "amount"); // Paid Media TV, Digital, Etc.
    var staticD54=926749.484438831;
    setVariableData("D54",convertAmount(staticD54,0,true), "amount"); // Other Activation Promotions, PR, Sponsorship, etc.
...
function calculateMainTable(columnIndex,columnName="") {
    ...
    if(columnIndex == "H"){
        setVariableData("H15",bottomTableData[columnIndex+'64'], "amount"); // VOLUME
        // setVariableData("H15",167178); // temp
        setVariableData("H39",bottomTableData["H52"], "amount"); // BRAND EXPENSE
    }
    var Formula29 = convertAmount((bottomTableData[columnIndex+'66'] || 0),0,true); // 'D66'
    setVariableData(columnIndex+"29",Formula29, "amount"); // STRIPPED NET SALES
    var Formula30 = convertAmount((evaluateFormula(columnIndex+'29/'+columnIndex+'15',true)) * 1000,2,false); // '(D29/D15)*1000'
    setVariableData(columnIndex+"30",Formula30, "amount"); // SNS/ 9L Case
    var Formula26 = convertAmount(evaluateFormula(columnIndex+'27*'+columnIndex+'15',true),0,true); // 'D27*D15'
    setVariableData(columnIndex+"26",Formula26, "amount"); // EXCISE TAXES
    var Formula23 = convertAmount(evaluateFormula(columnIndex+'29+'+columnIndex+'26',true),0); // 'D29+D26'
    setVariableData(columnIndex+"23",Formula23, "amount"); // NET SALES
    var Formula24 = convertAmount((evaluateFormula(columnIndex+'23/'+columnIndex+'15',true)) * 1000,2); // '(D23/D15)*1000'
    setVariableData(columnIndex+"24",Formula24, "amount"); // Net Sales/ 9L Case
    if(columnIndex == "H"){
        // main table
        var Formula20 = convertAmount(evaluateFormula(bottomTableData[columnIndex+'91']+'*'+bottomTableData['N90'],true),0,true); // 'H91*N90'
        // var Formula20 = convertAmount(evaluateFormula(bottomTableData[columnIndex+'91']+'*'+'16.41',true)); // 'H91*N90' // temp
        setVariableData(columnIndex+"20",Formula20, "amount"); // DISCOUNTS
        var Formula21 = convertAmount(evaluateFormula(columnIndex+'20/'+columnIndex+'15',true) * 1000,2); // 'H20*H15'
        ...
        var Formula53 = convertAmount(evaluateFormula('E53*(1+(I29/100))+'+bottomTableData['R65'],true)); // E53*(1+I$29)+R65
        setVariableData(columnIndex+"53",Formula53, "amount");// Paid Media
        var Formula54 = convertAmount(evaluateFormula('E54*(1+(I29/100))',true)); // E54*(1+I29)
        setVariableData(columnIndex+"54",Formula54, "amount");// Activation
        var Formula55 = convertAmount(evaluateFormula('E55*(1+(I29/100))',true)); // E55*(1+I29)
        setVariableData(columnIndex+"55",Formula55, "amount");// Activation
        var Formula52 = convertAmount(evaluateFormula(columnIndex+'53+'+columnIndex+'54+'+columnIndex+'55',true)); // 'H53+H54+H55'
        setVariableData(columnIndex+"52",Formula52, "amount");// Total Brand Spend

        // main table 
        setVariableData(columnIndex+"39",Formula52, "amount");// Brand Expense
    }
    else{
        var Formula20 = convertAmount(evaluateFormula(columnIndex+'21*'+columnIndex+'15',true),0,true); // 'D21*D15'
        setVariableData(columnIndex+"20",Formula20, "amount"); // DISCOUNTS
    }
    var Formula17 = convertAmount(evaluateFormula(columnIndex+'20+'+columnIndex+'23', true)); // 'D20+D23'
    setVariableData(columnIndex+"17",Formula17,"amount"); // Gross Sales
    var Formula18 = convertAmount((evaluateFormula(columnIndex+'17/'+columnIndex+'15',true) * 1000),2); // '(D17/D15)*1000'
    setVariableData(columnIndex+"18",Formula18, "amount"); // GS/ 9L Case (Front Line)

    var Formula32 = convertAmount((bottomTableData[columnIndex+'68'] || 0),0,true); // 'D68'
    setVariableData(columnIndex+"32",Formula32, "amount"); // COST OF SALES
    var Formula33 = convertAmount((evaluateFormula(columnIndex+'32/'+columnIndex+'15',true)) * 1000,2); // '(D32/D15)*1000'
    setVariableData(columnIndex+"33",Formula33, "amount"); // COS/ 9L Case

    var Formula35 = convertAmount(evaluateFormula(columnIndex+'29-'+columnIndex+'32',true)); // 'D29-D32'
    setVariableData(columnIndex+"35",Formula35, "amount"); // GROSS PROFIT
    var Formula36 = convertAmount((evaluateFormula(columnIndex+'35/'+columnIndex+'15',true)) * 1000,2); // '(D35/D15)*1000'
    setVariableData(columnIndex+"36",Formula36, "amount"); // GP/ 9L
    var Formula37 = convertAmount((evaluateFormula(columnIndex+'35/'+columnIndex+'29',true)) * 100,1); // '(D35/D29)*100 (perc)'
    setVariableData(columnIndex+"37",Formula37, "amount"); // Gross Margin (GP/ SNS)
    
    var Formula40 = convertAmount((evaluateFormula(columnIndex+'39/'+columnIndex+'29',true)) * 100,1); // '(D39/D29)*100 (perc)'
    setVariableData(columnIndex+"40",Formula40, "amount"); // Reinvestment Rate  (BE/ SNS)

    var Formula42 = convertAmount(evaluateFormula(columnIndex+'35-'+columnIndex+'39',true)); // 'D35-D39'
    setVariableData(columnIndex+"42",Formula42, "amount"); // BRAND PROFIT

    var Formula45 = convertAmount((evaluateFormula(columnIndex+'44/'+columnIndex+'29',true)) * 100,1); // '(D44/D29)*100 (perc)'
    setVariableData(columnIndex+"45",Formula45, "amount"); // SG&A Efficiency (SG&A/ SNS)

    var Formula47 = convertAmount(evaluateFormula(columnIndex+'42-'+columnIndex+'44',true)); // 'D42-D44'
    setVariableData(columnIndex+"47",Formula47, "amount");// OPERATING INCOME
    var Formula48 = convertAmount((evaluateFormula(columnIndex+'47/'+columnIndex+'29',true)) * 100,1); // '(D47/D29)*100 (perc)'
    setVariableData(columnIndex+"48",Formula48, "amount");// Operating Margin (OI/ SNS)
}
...
function calculateChangesInYearOfMainTable(columnIndex, compareColumnIndex1, compareColumnIndex2, columnName="") {
    ...
    var Formula15 = convertAmount(evaluateFormula(compareColumnIndex2+'15/'+compareColumnIndex1+'15-1',true) * 100, 1); 
    setVariableData(columnIndex+"15",Formula15, "percentage");
    var Formula17 = convertAmount(evaluateFormula(compareColumnIndex2+'17/'+compareColumnIndex1+'17-1',true) * 100, 1); 
    setVariableData(columnIndex+"17",Formula17, "percentage");
    var Formula18 = convertAmount(evaluateFormula(compareColumnIndex2+'18/'+compareColumnIndex1+'18-1',true) * 100, 1); 
    setVariableData(columnIndex+"18",Formula18, "percentage");
    var Formula20 = convertAmount(evaluateFormula(compareColumnIndex2+'20/'+compareColumnIndex1+'20-1',true) * 100, 1); 
    setVariableData(columnIndex+"20",Formula20, "percentage");
    var Formula21 = convertAmount(evaluateFormula(compareColumnIndex2+'21/'+compareColumnIndex1+'21-1',true) * 100, 1);3
    setVariableData(columnIndex+"21",Formula21, "percentage");
    var Formula23 = convertAmount(evaluateFormula(compareColumnIndex2+'23/'+compareColumnIndex1+'23-1',true) * 100, 1); 
    setVariableData(columnIndex+"23",Formula23, "percentage");
    var Formula24 = convertAmount(evaluateFormula(compareColumnIndex2+'24/'+compareColumnIndex1+'24-1',true) * 100, 1); 
    setVariableData(columnIndex+"24",Formula24, "percentage");
    var Formula26 = convertAmount(evaluateFormula(compareColumnIndex2+'26/'+compareColumnIndex1+'26-1',true) * 100, 1); 
    setVariableData(columnIndex+"26",Formula26, "percentage");
    var Formula27 = convertAmount(evaluateFormula(compareColumnIndex2+'27/'+compareColumnIndex1+'27-1',true) * 100, 1); 
    setVariableData(columnIndex+"27",Formula27, "percentage");
    var Formula29 = convertAmount(evaluateFormula(compareColumnIndex2+'29/'+compareColumnIndex1+'29-1',true) * 100, 1); 
    setVariableData(columnIndex+"29",Formula29, "percentage");
    var Formula30 = convertAmount(evaluateFormula(compareColumnIndex2+'30/'+compareColumnIndex1+'30-1',true) * 100, 1); 
    setVariableData(columnIndex+"30",Formula30, "percentage");
    var Formula32 = convertAmount(evaluateFormula(compareColumnIndex2+'32/'+compareColumnIndex1+'32-1',true) * 100, 1); 
    setVariableData(columnIndex+"32",Formula32, "percentage");
    var Formula33 = convertAmount(evaluateFormula(compareColumnIndex2+'33/'+compareColumnIndex1+'33-1',true) * 100, 1); 
    setVariableData(columnIndex+"33",Formula33, "percentage");
    var Formula35 = convertAmount(evaluateFormula(compareColumnIndex2+'35/'+compareColumnIndex1+'35-1',true) * 100, 1); 
    setVariableData(columnIndex+"35",Formula35, "percentage");
    var Formula37 = convertAmount(evaluateFormula(compareColumnIndex2+'37-'+compareColumnIndex1+'37',true),1); // pts 
    setVariableData(columnIndex+"37",Formula37, "percentage");
    var Formula39 = convertAmount(evaluateFormula(compareColumnIndex2+'39/'+compareColumnIndex1+'39-1',true) * 100, 1);
    setVariableData(columnIndex+"39",Formula39, "percentage");
    var Formula40 = convertAmount(evaluateFormula(compareColumnIndex2+'40-'+compareColumnIndex1+'40',true), 1); // pts
    setVariableData(columnIndex+"40",Formula40, "percentage");
    var Formula42 = convertAmount(evaluateFormula(compareColumnIndex2+'42/'+compareColumnIndex1+'42-1',true) * 100, 1);
    setVariableData(columnIndex+"42",Formula42, "percentage");
    var Formula44 = convertAmount(evaluateFormula(compareColumnIndex2+'44/'+compareColumnIndex1+'44-1',true) * 100, 1); 
    setVariableData(columnIndex+"44",Formula44, "percentage");
    var Formula45 = convertAmount(evaluateFormula(compareColumnIndex2+'45-'+compareColumnIndex1+'45',true), 1);  // pts
    setVariableData(columnIndex+"45",Formula45, "percentage");
    var Formula47 = convertAmount(evaluateFormula(compareColumnIndex2+'47/'+compareColumnIndex1+'47-1',true) * 100, 1); 
    setVariableData(columnIndex+"47",Formula47, "percentage");
    var Formula48 = convertAmount(evaluateFormula(compareColumnIndex2+'48-'+compareColumnIndex1+'48',true), 1); // pts
    setVariableData(columnIndex+"48",Formula48, "percentage"); 
...
function calculateChangesInTotalOfMainTable(columnIndex, compareColumnIndex1, compareColumnIndex2, columnName="") {
    ...
    var player = GetPlayer();
    // last year  D52 to D55
    var Formula52 = convertAmount(evaluateFormula(compareColumnIndex2+'52/'+compareColumnIndex1+'52-1',true) * 100, 1); // '(E52/D52-1)*100 (perc)'
    setVariableData(columnIndex+"52",Formula52, "percentage");// Total Brand Spend change
    var Formula53 = convertAmount(evaluateFormula(compareColumnIndex2+'53/'+compareColumnIndex1+'53-1',true) * 100, 1); //( SUM(E53:D53)-1)*100 (perc)
    setVariableData(columnIndex+"53",Formula53, "percentage"); // Paid Media TV, Digital, Etc.
    var Formula54 = convertAmount(evaluateFormula(compareColumnIndex2+'54/'+compareColumnIndex1+'54-1',true) * 100, 1); //( SUM(E54:D54)-1)*100 (perc)
    setVariableData(columnIndex+"54",Formula54, "percentage"); // Other Activation Promotions, PR, Sponsorship, etc.
    var Formula55 = convertAmount(evaluateFormula(compareColumnIndex2+'55/'+compareColumnIndex1+'55-1',true) * 100, 1); //( SUM(E55:D55)-1)*100 (perc)
    setVariableData(columnIndex+"55",Formula55, "percentage");  // Non Working Agency Fees, Market Research, etc.
...
function calculateTotalOfBottomTable(columnIndex,columnName="") {
    ...
    var Formula65 = convertAmount((bottomTableData[columnIndex+"66"]/bottomTableData[columnIndex+"64"]),2); // D66/D64 
    bottomTableData[columnIndex+"65"] = Formula65; // Total: Price/9L (SNS)

    var Formula68 = convertAmount((bottomTableData[columnIndex+"77"]+bottomTableData[columnIndex+"86"]+bottomTableData[columnIndex+"95"]+bottomTableData[columnIndex+"104"]+bottomTableData[columnIndex+"113"]+bottomTableData[columnIndex+"122"]+bottomTableData[columnIndex+"131"]+bottomTableData[columnIndex+"140"]),2); // D77+D86+D95+D104+D113+D122+D131+D140   (total of COS Total of all type of measurement)
    bottomTableData[columnIndex+"68"] = Formula68; // Total: COS Total

    var Formula67 = convertAmount((bottomTableData[columnIndex+"68"]/bottomTableData[columnIndex+"64"]),2); // D68/D64
    bottomTableData[columnIndex+"67"] = Formula67; // Total: COS/9L

    var Formula69 = convertAmount((bottomTableData[columnIndex+"65"]-bottomTableData[columnIndex+"67"]),2); // D65-D67
    ...
    var Formula71 = convertAmount(((bottomTableData[columnIndex+"69"]/bottomTableData[columnIndex+"65"])*100),1); // (D69/D65)*100 (perc) 
...
function calculateKToRColumn() {
    ...
    // MEDIA R65===============
    bottomTableData["R65"] = convertAmount(FormulaR65,2);
    bottomTableData["N90"] = convertAmount(FormulaN90,2);

    // 750 Ml===============
    var FormulaK139 = convertAmount(evaluateFormula(bottomTableData['E139']+"+"+bottomTableData['P139'], false),2); // 'E139+P139'
    bottomTableData["K139"] = FormulaK139;

    var FormulaK137 = convertAmount(evaluateFormula(bottomTableData['E137']+"*"+bottomTableData['M137'], false),2); // 'E137*M137'
    bottomTableData["K137"] = FormulaK137;
    
    // K91
    var FormulaK91 = convertAmount(evaluateFormula('('+bottomTableData['E91']+"*"+bottomTableData['L91']+"*"+bottomTableData['M91']+"*"+bottomTableData['O91']+"*"+bottomTableData['N91']+"*"+bottomTableData['P91']+"*"+bottomTableData['R91']+')+'+bottomTableData['Q91'], false)); // (E91*L91*M91*O91*N91*P91*R91)+Q91)
    bottomTableData["K91"] = FormulaK91;

    // K136
    var FormulaK136 = convertAmount(evaluateFormula('('+bottomTableData['K91']+"*"+bottomTableData['O136']+')*'+bottomTableData['M136']+'*'+bottomTableData['P136']+'*'+bottomTableData['R136'], false)); // (K$91*O136)*M136*P136*R136)
    bottomTableData["K136"] = FormulaK136;

    // 750ml VAP===================
    // K130
    var FormulaK130 = convertAmount(evaluateFormula(bottomTableData['E130']+"+"+bottomTableData['P130']+'+'+bottomTableData['Q130'], false),2); // E130+P130+Q130
    bottomTableData["K130"] = FormulaK130;
    // K128
    var FormulaK128 = convertAmount(evaluateFormula(bottomTableData['E128']+"*"+bottomTableData['M128'], false),2); // E128*M128
    ...
    // 50ml===================
    // K121
    var FormulaK121 = convertAmount(evaluateFormula(bottomTableData['E121']+"+"+bottomTableData['P121'], false),2); // E121+P121
    bottomTableData["K121"] = FormulaK121;
    // K119
    var FormulaK119 = convertAmount(evaluateFormula(bottomTableData['E119']+"*"+bottomTableData['M119'], false),2); // E119*M119
    bottomTableData["K119"] = FormulaK119;
    // K118
    var FormulaK118 = convertAmount(evaluateFormula('('+bottomTableData['K91']+"*"+bottomTableData['O118']+')*'+bottomTableData['M118']+'*'+bottomTableData['P118']+'*'+bottomTableData['R118'], false)); // (K$91*O118)*M118*P118*R118
    ...
    // 375ml===================
    // K103
    var FormulaK103 = convertAmount(evaluateFormula(bottomTableData['E103']+"+"+bottomTableData['P103'], false),2); // E103+P103
    bottomTableData["K103"] = FormulaK103;
    // K101
    var FormulaK101 = convertAmount(evaluateFormula(bottomTableData['E101']+"*"+bottomTableData['M101'], false),2); // E101*M101
    bottomTableData["K101"] = FormulaK101;
    // K100
    var FormulaK100 = convertAmount(evaluateFormula('('+bottomTableData['K91']+"*"+bottomTableData['O100']+')*'+bottomTableData['M100']+'*'+bottomTableData['P100']+'*'+bottomTableData['R100'], false)); // (K$91*O100)*M100*P100*R100
    bottomTableData["K100"] = FormulaK100;

    // 750ml===================
    // K94
    var FormulaK94 = convertAmount(evaluateFormula(bottomTableData['E94']+"+"+bottomTableData['P94'], false),2); // E103+P103
    bottomTableData["K94"] = FormulaK94;
    // K92
    var FormulaK92 = convertAmount(evaluateFormula(bottomTableData['E92']+"*"+bottomTableData['M92']+"*"+bottomTableData['N92'], false),2); // E92*M92*N92
    bottomTableData["K92"] = FormulaK92;

    // 1 L=================================
    // K85
    var FormulaK85 = convertAmount(evaluateFormula(bottomTableData['E85']+"+"+bottomTableData['P85'], false),2); // E85+P85
    bottomTableData["K85"] = FormulaK85;
    // K83
    var FormulaK83 = convertAmount(evaluateFormula(bottomTableData['E83']+"*"+bottomTableData['M83'], false),2); // E83*M83
    bottomTableData["K83"] = FormulaK83;
    // K82 
    var FormulaK82 = convertAmount(evaluateFormula('('+bottomTableData['E82']+"*"+bottomTableData['L82']+"*"+bottomTableData['M82']+"*"+bottomTableData['O82']+"*"+bottomTableData['P82']+"*"+bottomTableData['R82']+')', false)); // (E82*L82*M82*O82*P82*R82)
    bottomTableData["K82"] = FormulaK82;

    // 1.75 L=================================
    // K76
    var FormulaK76 = convertAmount(evaluateFormula(bottomTableData['E76']+"+"+bottomTableData['P76'], false),2); // E76+P76
    bottomTableData["K76"] = FormulaK76;
    // K74
    var FormulaK74 = convertAmount(evaluateFormula(bottomTableData['E74']+"*"+bottomTableData['M74'], false),2); // E74*M74
    bottomTableData["K74"] = FormulaK74;
    // K73 
    var FormulaK73 = convertAmount(evaluateFormula('('+bottomTableData['K91']+"*"+bottomTableData['O73']+")*"+bottomTableData['M73']+"*"+bottomTableData['P73']+"*"+bottomTableData['R73'], false)); // (K$91*O73)*M73*P73*R73
...
function calculateBottomTable(columnIndex,columnName="") {
    ...
    // 1.75L === D73 to D80
    var Formula75 = convertAmount(evaluateFormula(columnIndex+'73*'+columnIndex+'74', false)); // 'D73*D74'
    bottomTableData[columnIndex+"75"] = Formula75; // Total SNS
    var Formula77 = convertAmount(evaluateFormula(columnIndex+'76*'+columnIndex+'73',false)); // 'D76*D73'
    bottomTableData[columnIndex+"77"] = Formula77; // COS Total
    var Formula78 = convertAmount(evaluateFormula(columnIndex+'74-'+columnIndex+'76', false),2); // 'D74-D76'
    bottomTableData[columnIndex+"78"] = Formula78; // GP/9L
    var Formula79 = convertAmount(evaluateFormula(columnIndex+'75-'+columnIndex+'77', false)); // 'D75-D77'
    bottomTableData[columnIndex+"79"] = Formula79; // GP Total
    var Formula80 = convertAmount(evaluateFormula(columnIndex+'78/'+columnIndex+'74', false) * 100,1); // '(D78/D74)*100 (perc)'
    bottomTableData[columnIndex+"80"] = Formula80; // GP Margin
    // 1L === D82 to D89
    var Formula84 = convertAmount(evaluateFormula(columnIndex+'82*'+columnIndex+'83', false)); // 'D82*D83'
    bottomTableData[columnIndex+"84"] = Formula84; // Total SNS
    var Formula86 = convertAmount(evaluateFormula(columnIndex+'85*'+columnIndex+'82',false)); // 'D85*D82'
    bottomTableData[columnIndex+"86"] = Formula86; // COS Total
    var Formula87 = convertAmount(evaluateFormula(columnIndex+'83-'+columnIndex+'85', false),2); // 'D83-D85'
    bottomTableData[columnIndex+"87"] = Formula87; // GP/9L
    var Formula88 = convertAmount(evaluateFormula(columnIndex+'84-'+columnIndex+'86', false)); // 'D84-D86'
    bottomTableData[columnIndex+"88"] = Formula88; // GP Total
    var Formula89 = convertAmount(evaluateFormula(columnIndex+'87/'+columnIndex+'83', false) * 100,1); // '(D87/D83)*100 (perc)'
    bottomTableData[columnIndex+"89"] = Formula89; // GP Margin
    // 750 ml === D91 to D98
    var Formula93 = convertAmount(evaluateFormula(columnIndex+'91*'+columnIndex+'92', false)); // 'D91*D92'
    bottomTableData[columnIndex+"93"] = Formula93; // Total SNS
    var Formula95 = convertAmount(evaluateFormula(columnIndex+'94*'+columnIndex+'91',false)); // 'D91*D92'
    bottomTableData[columnIndex+"95"] = Formula95; // COS Total
    var Formula96 = convertAmount(evaluateFormula(columnIndex+'92-'+columnIndex+'94', false),2); // 'D92-D94'
    bottomTableData[columnIndex+"96"] = Formula96; // GP/9L
    var Formula97 = convertAmount(evaluateFormula(columnIndex+'93-'+columnIndex+'95', false)); // 'D93-D95'
    bottomTableData[columnIndex+"97"] = Formula97; // GP Total
    var Formula98 = convertAmount(evaluateFormula(columnIndex+'96/'+columnIndex+'92', false) * 100,1); // '(D96/D92)*100 (perc)'
    bottomTableData[columnIndex+"98"] = Formula98; // GP Margin
    // 375 ml === D100 to D107
    var Formula102 = convertAmount(evaluateFormula(columnIndex+'100*'+columnIndex+'101', false)); // 'D100*D101'
    bottomTableData[columnIndex+"102"] = Formula102; // Total SNS
    var Formula104 = convertAmount(evaluateFormula(columnIndex+'103*'+columnIndex+'100',false)); // 'D103*D100'
    bottomTableData[columnIndex+"104"] = Formula104; // COS Total
    var Formula105 = convertAmount(evaluateFormula(columnIndex+'101-'+columnIndex+'103', false),2); // 'D101-D103'
    bottomTableData[columnIndex+"105"] = Formula105; // GP/9L
    var Formula106 = convertAmount(evaluateFormula(columnIndex+'102-'+columnIndex+'104', false)); // 'D102-D104'
    bottomTableData[columnIndex+"106"] = Formula106; // GP Total
    var Formula107 = convertAmount(evaluateFormula(columnIndex+'105/'+columnIndex+'101', false) * 100,1); // '(D105/D101)*100 (perc)'
    bottomTableData[columnIndex+"107"] = Formula107; // GP Margin
    // 200 ml === D109 to D116
    var Formula111 = convertAmount(evaluateFormula(columnIndex+'109*'+columnIndex+'110', false)); // 'D109*D110'
    bottomTableData[columnIndex+"111"] = Formula111; // Total SNS
    var Formula113 = convertAmount(evaluateFormula(columnIndex+'112*'+columnIndex+'109',false)); // 'D112*D109'
    bottomTableData[columnIndex+"113"] = Formula113; // COS Total
    var Formula114 = convertAmount(evaluateFormula(columnIndex+'110-'+columnIndex+'112', false),2); // 'D110-D112'
    bottomTableData[columnIndex+"114"] = Formula114; // GP/9L
    var Formula115 = convertAmount(evaluateFormula(columnIndex+'111-'+columnIndex+'113', false)); // 'D111-D113'
    bottomTableData[columnIndex+"115"] = Formula115; // GP Total
    var Formula116 = convertAmount(evaluateFormula(columnIndex+'114/'+columnIndex+'110', false) * 100,1); // '(D114/D110)*100 (perc)'
    bottomTableData[columnIndex+"116"] = Formula116; // GP Margin
    // 50 ml === D118 to D125
    var Formula120 = convertAmount(evaluateFormula(columnIndex+'118*'+columnIndex+'119', false)); // 'D118*D119'
    bottomTableData[columnIndex+"120"] = Formula120; // Total SNS
    var Formula122 = convertAmount(evaluateFormula(columnIndex+'121*'+columnIndex+'118',false)); // 'D121*D118'
    bottomTableData[columnIndex+"122"] = Formula122; // COS Total
    var Formula123 = convertAmount(evaluateFormula(columnIndex+'119-'+columnIndex+'121', false),2); // 'D119-D121'
    bottomTableData[columnIndex+"123"] = Formula123; // GP/9L
    var Formula124 = convertAmount(evaluateFormula(columnIndex+'120-'+columnIndex+'122', false)); // 'D120-D122'
    bottomTableData[columnIndex+"124"] = Formula124; // GP Total
    var Formula125 = convertAmount(evaluateFormula(columnIndex+'123/'+columnIndex+'119', false) * 100,1); // '(D123/D119)*100 (perc)'
    bottomTableData[columnIndex+"125"] = Formula125; // GP Margin
    // 750ml VAP === D127 to D134
    var Formula129 = convertAmount(evaluateFormula(columnIndex+'127*'+columnIndex+'128', false)); // 'D127*D128'
    bottomTableData[columnIndex+"129"] = Formula129; // Total SNS
    var Formula131 = convertAmount(evaluateFormula(columnIndex+'130*'+columnIndex+'127',false)); // 'D130*D127'
    bottomTableData[columnIndex+"131"] = Formula131; // COS Total
    var Formula132 = convertAmount(evaluateFormula(columnIndex+'128-'+columnIndex+'130', false),2); // 'D128-D130'
    bottomTableData[columnIndex+"132"] = Formula132; // GP/9L
    var Formula133 = convertAmount(evaluateFormula(columnIndex+'129-'+columnIndex+'131', false)); // 'D129-D131'
    bottomTableData[columnIndex+"133"] = Formula133; // GP Total
    var Formula134 = convertAmount(evaluateFormula(columnIndex+'132/'+columnIndex+'128', false) * 100,1); // '(D132/D128)*100 (perc)'
    bottomTableData[columnIndex+"134"] = Formula134; // GP Margin
    // 750ml === D136 to D143
    var Formula138 = convertAmount(evaluateFormula(columnIndex+'136*'+columnIndex+'137', false)); // 'D136*D137'
    bottomTableData[columnIndex+"138"] = Formula138; // Total SNS
    var Formula139 = convertAmount(bottomTableData[columnIndex+'94']*1.2,2); // 'D94*1.2'
    bottomTableData[columnIndex+"139"] = Formula139; // COS/9L
    var Formula140 = convertAmount(evaluateFormula(columnIndex+'139*'+columnIndex+'136',false)); // 'D139*D136'
    bottomTableData[columnIndex+"140"] = Formula140; // COS Total
    var Formula141 = convertAmount(evaluateFormula(columnIndex+'137-'+columnIndex+'139', false),2); // 'D137-D139'
    bottomTableData[columnIndex+"141"] = Formula141; // GP/9L
    var Formula142 = convertAmount(evaluateFormula(columnIndex+'138-'+columnIndex+'140', false)); // 'D138-D140'
    bottomTableData[columnIndex+"142"] = Formula142; // GP Total
    var Formula143 = convertAmount(evaluateFormula(columnIndex+'141/'+columnIndex+'137', false) * 100,1); // '(D141/D137)*100 (perc)'
    bottomTableData[columnIndex+"143"] = Formula143; // GP Margin
}
function displayValuesForColoredTable(){
    // var player = GetPlayer();
    setVariableData("M2",bottomTableData["I15"], "percentage");
    setVariableData("M3",bottomTableData["I29"], "percentage");
    setVariableData("M4",bottomTableData["I30"], "percentage");
    setVariableData("M5",bottomTableData["I35"], "percentage");
    setVariableData("M6",bottomTableData["I37"], "percentage");
    setVariableData("M7",bottomTableData["I39"], "percentage");
    setVariableData("M8",bottomTableData["I40"], "percentage");
    setVariableData("M9",bottomTableData["I42"], "percentage");
    setVariableData("M10",bottomTableData["I47"], "percentage");
    setVariableData("M11",bottomTableData["I48"], "percentage");
}
function convertAmount(amount, fractionDigit=0, allowConversion=false){
    // var amount = 3578183.33760167;
    if(allowConversion){
        amount = (amount/1000);
    }
    // var formattedAmount = Number(amount).toFixed(fractionDigit);
...
function setVariableData(key, value, valueType){
    var player = GetPlayer();
